...
var formFooter = document.getElementById('footer_form')

// Adaptive menu

var menuButton = document.getElementById('heading__nav-menuBurger')
menuButton.addEventListener('click', () => {
   var menuElems = document.getElementsByClassName('heading__nav-items')[0]
   menuElems.classList.toggle('activeMenu')
   menuButton.classList.toggle('activeBurger')
})


var menuElems = document.getElementsByClassName('heading__nav-items')[0]
for (let i = 0; i < menuElems.children.length; i++) {
   menuElems.children[i].addEventListener('click', () => {
      menuElems.classList.remove('activeMenu')
      menuButton.classList.remove('activeBurger')
   })
}